                ...
                <div class="table-responsive">
                    <table class="table table-hover">
                        ...
                        <tbody>
                            @foreach ($data as $d)
                                <tr>
                                    <td>{{ $d->peminjam->name }}</td>
    <td>{{ $d->komik->judul_comic }}</td>
                                    <td>{{ $d->status }}</td>
                                    <td>
                                        <a href="{{ route('edit.peminjaman', $d->id_peminjaman) }}" class="btn btn-success"><i class="fas fa-sync-alt"></i>Update</a>
                                        <a href="{{ route('destroy.pemin', $d->id_peminjaman) }}" class="btn btn-danger"><i class="fas fa-trash-alt"></i>Hapus</a>
